...
#SBATCH --output=/home/emmanuel.keku/logs/behavior_v3_%j.out

#SBATCH --error=/home/emmanuel.keku/logs/behavior_v3_%j.err
...
python3 /home/emmanuel.keku/experiment_bg_v3.py 2>&1 | tee /home/emmanuel.keku/logs/behavior_v3.log
